...
namespace uk.vroad.ucm
{
    public abstract class UaMapMeshMod: UaMapMesh
    {
        ...
        protected override void Awake()
        {
            ...
            goMeshRoadPoints = NewGoMesh(MESH_ROAD_POINTS, materialTemplates.opaque, ROAD_PT_COL);
            goMeshPedPoints = NewGoMesh(MESH_PED_POINTS, materialTemplates.opaque, PED_PT_COL);
            goMeshBuildPoints = NewGoMesh(MESH_BUILD_POINTS, materialTemplates.opaque, BUILD_PT_COL);
            goMeshMovedLines = NewGoMesh(MESH_MOVED_LINES, materialTemplates.transparent, LINE_COL);
